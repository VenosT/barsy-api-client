...
class Store{
   ...
   * @see Store
   */
  public function amounts($action_type = 'content', $active_struct_id = null, $id = null, $filters = [], $page_num = 1, $rows = 50, $order_by = null, $order_dir = null, $columns = null, $values = null, $search = null, $params = null, $extra_elements = null, $image_col_size = null, $template_id = null, $copies = 1, string $response_type = null){

    $bact = BarsyApiAction::create('Store_amounts')
