...
class Destinations{
  ...
  /**
   * Списък с държавите
   * @param \Barsy\Data\Destinations\CountriesFiltersData $filters null Налични филтри
   * @param string $response_type Тип да отговора на сървъра (json|res|pdf|html|xml|txt|csv|excel) По подразбиране: json
   * @return \Barsy\Data\Destinations\CountryData[]
   * @throws BarsyApiClientFault
   * @throws BarsyApiClientMessage
   * @see Destinations
   */
  public function getlistcountries($filters, string $response_type = null){

    $bact = BarsyApiAction::create('Destinations_getlistcountries')
  ...
  /**
   * Списък с дестинации
   * @param array $filters [] Списък от филтри
   * @param string $response_type Тип да отговора на сървъра (json|res|pdf|html|xml|txt|csv|excel) По подразбиране: json
   * @return array 
   * @throws BarsyApiClientFault
   * @throws BarsyApiClientMessage
  ...
  public function getlist($filters = [], string $response_type = null){
    ...
    $bact = BarsyApiAction::create('Destinations_getlist')
     ->setParam('filters',$filters);
