...
class Modificators{
  ...
  /**
   * Връща списък с модификатори в системата
   * @param string $pattern null филтрира резултата по подаден стринг
   ...
   * @see Modificators
   */
  public function getlist($pattern = null, $order = 1, $offset = 0, string $response_type = null){

    $bact = BarsyApiAction::create('Modificators_getlist')
