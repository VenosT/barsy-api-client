...
class Storemoves{
   ...
   * @param \Barsy\Data\StoreMoves\StoreMoveCreateData $storemove null Данни за прехвърлянето
   * @param string $response_type Тип да отговора на сървъра (json|res|pdf|html|xml|txt|csv|excel) По подразбиране: json
   ...
   * @param \Barsy\Data\StoreMoves\StoreMoveCreateData $storemove null Обект, съдържаш информация за прехвърлянето
   ...
   * @param \Barsy\Data\StoreMoves\StoreMovesListFiltersData $filters null
